...
fun DesiredWeightScreen(
    onDesiredWeightSelected: (Int) -> Unit,
    onNextClick: () -> Unit,
) {
    ...
    Column(
        ...
        Column(
            ...
            // Підзаголовок
            Text(
                text = "Ваша бажана вага це головне для створення плану для вас та для досягнення цілі разом з нами",
                fontSize = 16.sp,
                color = Color.White,
        ...
        Button(
            onClick = {
                onDesiredWeightSelected(selectedDesiredWeight.value)
                onNextClick()
            },
            modifier = Modifier
                .fillMaxWidth()
